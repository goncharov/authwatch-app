...
public interface OptionalFeatures {
  ...
  /**
   * Invoked when the {@link com.google.android.apps.authenticator.AuthenticatorActivity} {@code onCreate} is almost done.
   */
  void onAuthenticatorActivityCreated(AuthenticatorActivity activity);

  /**
   * Invoked when the {@link com.google.android.apps.authenticator.AuthenticatorActivity} saves an account/seed.
   */
  void onAuthenticatorActivityAccountSaved(Context context, String account);

  /**
   * Creates the {@link com.google.android.apps.authenticator.OtpSource} instance used for OTP generation by the app.
   */
  OtpSource createOtpSource(AccountDb accountDb, TotpClock totpClock);

  /**
   * Invoked when a HOTP OTP could not be generated by {@link com.google.android.apps.authenticator.AuthenticatorActivity}
  ...
  /**
   * Invoked by {@link com.google.android.apps.authenticator.AuthenticatorActivity#onCreateDialog(int)} for dialog IDs not directly
   * handled by the {@link com.google.android.apps.authenticator.AuthenticatorActivity} class.
   *
  ...
  /**
   * Invoked when {@link com.google.android.apps.authenticator.AuthenticatorActivity} was asked to initiate the Add Account flow.
   */
  ...
  /**
   * Gets the {@link android.content.SharedPreferences} into which to import preferences from the old Authenticator
   * app.
   *
