...
/**
 * Controller of the {@link com.google.android.apps.authenticator.timesync.SyncNowActivity}. As soon as started, the controller attempts to
 * obtain the network time using a {@link com.google.android.apps.authenticator.timesync.NetworkTimeProvider}, then computes the offset between
 * the device's system time and the network time and updates {@link com.google.android.apps.authenticator.TotpClock} to use that as
...
class SyncNowController {
   ...
   * using the provided {@link android.os.Handler}.
   */
