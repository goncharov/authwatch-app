 ...
 * {@link #configureForProductionIfNotConfigured(android.content.Context)} or
 * {@link #resetForIntegrationTesting(android.content.Context)}.
 * After that its clients can access the various objects such as {@link com.google.android.apps.authenticator.AccountDb} using the
 ...
 * injectable objects (e.g., {@link #setAccountDb(com.google.android.apps.authenticator.AccountDb) setAccountDb}). To avoid inter-test
 * state-leakage, each test should invoke {@link #resetForIntegrationTesting(android.content.Context)}.
 *
...
public final class DependencyInjector {
  ...
  /**
   * Gets the {@link android.content.Context} passed the instances created by this injector.
   */
  ...
  /**
   * Sets the {@link com.google.android.apps.authenticator.AccountDb} instance returned by this injector. This will prevent the injector
  ...
  /**
   * Sets the {@link com.google.android.apps.authenticator.OtpSource} instance returned by this injector. This will prevent the injector
   * from creating its own instance.
   */
  ...
  /**
   * Sets the {@link com.google.android.apps.authenticator.TotpClock} instance returned by this injector. This will prevent the injector
   * from creating its own instance.
   */
  ...
  /**
   * Sets the {@link android.content.pm.PackageManager} instance returned by this injector. This will prevent the
  ...
  /**
   * Sets the {@link com.google.android.apps.authenticator.testability.StartActivityListener} instance returned by this injector.
   */
  ...
  /**
   * Sets the {@link com.google.android.apps.authenticator.dataimport.ImportController} instance returned by this injector. This will prevent the
   * injector from creating its own instance.
   */
  ...
  /**
   * Sets the {@link org.apache.http.client.HttpClient} instance returned by this injector. This will prevent the
   * injector from creating its own instance.
   */
