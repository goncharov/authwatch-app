...
/**
 * Imports the contents of {@link com.google.android.apps.authenticator.AccountDb} and the key material and settings from a
...
public class Importer {
  ...
  /**
   * Imports the contents of the provided {@link android.os.Bundle} into the provided {@link com.google.android.apps.authenticator.AccountDb} and
   * {@link android.content.SharedPreferences}. Does not overwrite existing records in the database.
   *
   * @param bundle source bundle.
   * @param accountDb destination {@link com.google.android.apps.authenticator.AccountDb}.
